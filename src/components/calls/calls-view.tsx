  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          { title: 'Total Calls', value: '0', change: 'No activity yet', icon: Phone, accent: 'emerald' },
          { title: 'Avg Duration', value: '—', change: 'No data', icon: Clock, accent: 'cyan' },
          { title: 'Connection Rate', value: '—', change: 'No data', icon: PhoneCall, accent: 'violet' },
          { title: 'Booked Meetings', value: '0', change: 'No data', icon: Calendar, accent: 'amber' },
        ].map((stat) => {
      ...
      <Card className="card-premium border-border/40 max-w-lg w-full mx-auto">
        <CardContent className="p-8 text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-foreground">No Calls Yet</h2>
          <p className="text-muted-foreground text-sm leading-relaxed">
            No calls yet. Call activity from your outreach campaigns will appear here.
          </p>
        </CardContent>
      </Card>
    </div>
