  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          { title: 'Total Visitors', value: '0', change: 'No data yet', icon: Eye, accent: 'emerald' },
          { title: 'Identified Companies', value: '0', change: 'No data', icon: Building2, accent: 'cyan' },
          { title: 'Returning', value: '0', change: 'No data', icon: RefreshCw, accent: 'violet' },
          { title: 'Avg Session', value: '—', change: 'No data', icon: Clock, accent: 'amber' },
        ].map((stat) => {
      ...
      <Card className="card-premium border-border/40 max-w-lg w-full mx-auto">
        <CardContent className="p-8 text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-foreground">No Visitor Data</h2>
          <p className="text-muted-foreground text-sm leading-relaxed">
            No visitor data. Website visitor tracking will appear here once configured.
          </p>
        </CardContent>
      </Card>
    </div>
