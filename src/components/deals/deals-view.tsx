  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          { title: 'Pipeline Value', value: '$0', change: 'No deals yet', icon: DollarSign, accent: 'emerald' },
          { title: 'Closed Won', value: '$0', change: 'No data', icon: Trophy, accent: 'cyan' },
          { title: 'Active Deals', value: '0', change: 'No deals yet', icon: Target, accent: 'violet' },
          { title: 'Win Rate', value: '—', change: 'No data', icon: TrendingUp, accent: 'amber' },
        ].map((stat) => {
      ...
      <Card className="card-premium border-border/40 max-w-lg w-full mx-auto">
        <CardContent className="p-8 text-center space-y-4">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            No deals yet. Deals from your pipeline will appear here.
          </p>
        </CardContent>
      </Card>
    </div>
