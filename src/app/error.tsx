...
/**
 * LeadReach — Error Boundary
 * =============================
 * Catches unhandled errors within page-level components.
 * Preserves the layout (sidebar, topbar) while showing the error.
 *
...
export default function Error({
  ...
  console.error('[LeadReach] Page error boundary caught:', error);
