/**
 * LeadReach — Client-Safe Plan Definitions
 * ==========================================
 * Plan data and utility functions that are safe to import in client components.
 * This module does NOT import the Stripe SDK.
 *
 * For server-side Stripe operations, use @/lib/stripe-config instead.
 */
