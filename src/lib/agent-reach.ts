...
const CHANNEL_DEFINITIONS: Omit<AgentReachChannelInfo, 'lastChecked'>[] = [
  ...
  },
  {
    ...
    description: 'Professional profiles, company pages, job search, and lead extraction via multi-source pipeline',
    status: 'ok',
    tier: 0,
    backend: 'Exa + Jina Reader (Smart Fallback)',
    message: 'Active — searches LinkedIn profiles and companies via Exa semantic search + Jina Reader',
    icon: '💼',
  },
  {
    name: 'twitter',
    displayName: 'Twitter/X',
    description: 'Tweet search, user timelines, threads, and long-form articles for social lead intelligence',
    status: 'ok',
    tier: 0,
    backend: 'Exa + Jina Reader (Smart Fallback)',
    message: 'Active — searches tweets and profiles via Exa semantic search + Jina Reader',
    icon: '🐦',
 },
  {
    name: 'youtube',
