...
# Database: Now using Supabase PostgreSQL (no local DB needed in build)
# The DATABASE_URL is set via .env and points to Supabase
echo "🗄️  Database: Supabase PostgreSQL (configured via .env)"
echo "   DATABASE_URL is injected at runtime from environment variables"
